# Budget Breakdown
**Detailed Cost Estimates for 2 People**
...
|------|--------------|
| 7-Day JR Pass | €620 |
| Your actual train costs | ~€330 |
| **You save** | **€290** |

JR Pass is NOT worth it because you fly to Okinawa instead of returning by train.

### Ways to Save
| Change | Savings |
|--------|---------|
| Local trains instead of some Shinkansen | €30-50 |
| Budget airline for domestic flights | €50-100 |
| Smaller rental car | €40 |
...
- **Lunch:** €12.50/person - casual restaurant, market food
- **Dinner:** €20/person - mid-range restaurant

### Ways to Save
| Change | Savings |
|--------|---------|
| Konbini breakfast (3 days) | €15 |
| Konbini dinner (2 days) | €30 |
| Supermarket bento evenings | €20 |

### Splurge Nights (Built In)
- Farewell sushi dinner in Tokyo
- Nice dinner in Gion (Kyoto)
- Seafood feast in Okinawa

---

## Activities & Entrance Fees

| Activity | Location | Cost (2 ppl) |
|----------|----------|--------------|
...
- Meiji Shrine (free)
- Nara deer (free, crackers ¥200)
- Most shrine/temple grounds (free, main halls may charge)
- Tokyo Metropolitan Government Building views (free)
...
|----------|---------------|
| 1 EUR | ~160 JPY |
| 10,000 JPY | ~62.50 EUR |

These rates fluctuate - check current rates before trip.
...
Recommended: Keep €200-300 extra accessible for:
- Unexpected transport (taxis in rain)
- Medical needs
- Lost/stolen items
...
| Item | Notes |
|------|-------|
| International flights | ~€1,200-1,500/person (separate budget) |
| Travel insurance | ~€50-100/person |
| Shopping/souvenirs | Budget separately based on preference |
| Alcohol | Not heavily budgeted (add if needed) |

---

## Payment Planning

| Method | Use For | Amount to Prep |
|--------|---------|----------------|
| **Cash (Yen)** | Small restaurants, temples, some attractions | ¥50,000 (~€310) on arrival |
| **Credit Card** | Hotels, large purchases, many restaurants | Primary card + backup |
| **IC Card (Suica)** | Transport, konbini, vending machines | Load as needed (¥5,000-10,000 at a time) |

---

## Budget vs. Experience Trade-offs
