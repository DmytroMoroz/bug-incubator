...
### BOOK NOW (3+ Months Ahead) ⚠️

These sell out or get expensive - don't wait!
...
|------|--------------|-------|
| **eSIM for Japan** | ubigi.com | Buy & install before flight, activate on landing. ~€20-50/person |
| **International Driving Permit** | Your country's auto association (e.g., ÖAMTC in Austria) | Required for Okinawa! Takes 1-2 weeks |
| **Travel insurance** | Your insurance provider, online | Highly recommended |
| **Download apps** | App Store / Google Play | See [Practical Info](06_practical_info.md) |
| **Notify bank** | Call or app | Avoid card blocks abroad |
| **Japanese Yen** | Your bank or exchange | ~€200-300 worth for arrival |
...
| Downloaded Google Maps offline (Japan) | [ ] |
| Downloaded Google Translate (Japanese) | [ ] |
| Downloaded NAVITIME app | [ ] |
| Printed/saved key confirmations | [ ] |
| International Driving Permit (for Okinawa) | [ ] |
| Cash withdrawn (¥30,000-50,000) | [ ] |
| ICOCA cards ready (you have them!) | [✓] |
...
### Flights
- **Use incognito mode** when searching (avoid price tracking)
- **Check multi-city** options (fly into Tokyo, out of Tokyo)
- **Book on Tuesday/Wednesday** - often cheapest
- **Set price alerts** on Google Flights

### Hotels
- **Booking.com** - largest selection, free cancellation often available
- **Agoda** - sometimes cheaper for Asia
...
- **Peach/Jetstar** - budget, watch baggage fees
- **Book 1-2 months ahead** for best prices
...
| Category | Website |
|----------|---------|
| **Flights** | skyscanner.com, google.com/flights |
| **Hotels** | booking.com, agoda.com |
| **Ryokans** | booking.com, japanican.com, direct websites |
| **Activities** | klook.com, viator.com |
| **Trains** | japan-guide.com, hyperdia.com |
| **Car Rental** | nipponrentacar.co.jp, toyota.rental.co.jp |

---

[← Back to Overview](00_TRIP_OVERVIEW.md) | [Next: Budget →](09_budget.md)
